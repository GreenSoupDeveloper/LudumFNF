...
class SuccessState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (PlayState.missedNotesNumber > PlayState.sickNotesNumber
			&& PlayState.missedNotesNumber > PlayState.goodNotesNumber
			&& PlayState.missedNotesNumber > PlayState.badNotesNumber
			&& PlayState.missedNotesNumber > PlayState.shitNotesNumber)
		{
		...
		if (PlayState.sickNotesNumber > 0 && PlayState.goodNotesNumber == 0 && PlayState.badNotesNumber == 0 && PlayState.shitNotesNumber == 0
		...
		if (finalScoreNote == 4)
		{
			FlxG.sound.playMusic('assets/shared/music/successScreen/perfect/resultsPERFECT' + TitleState.soundExt);
		}
		else if (finalScoreNote == 3)
		{
			FlxG.sound.playMusic('assets/shared/music/successScreen/excellent/resultsEXCELLENT-intro' + TitleState.soundExt, false);
			// FlxG.sound.playMusic('assets/music/successScreen/excellent/resultsEXCELLENT' + TitleState.soundExt);
		}
		else if (finalScoreNote == 2)
		{
			FlxG.sound.playMusic('assets/shared/music/successScreen/normal/resultsNORMAL' + TitleState.soundExt);
		}
		else if (finalScoreNote == 1)
		{
			FlxG.sound.playMusic('assets/shared/music/successScreen/bad/resultsBAD' + TitleState.soundExt);
		}
		else if (finalScoreNote == 0)
		{
			FlxG.sound.playMusic('assets/shared/music/successScreen/shit/resultsSHIT' + TitleState.soundExt, false);
		}
		else
		{
			FlxG.sound.playMusic('assets/shared/music/successScreen/normal/resultsNORMAL' + TitleState.soundExt);
	...
	override function update(elapsed:Float)
	{
		if (!FlxG.sound.music.playing && finalScoreNote == 3)
			FlxG.sound.playMusic('assets/shared/music/successScreen/excellent/resultsEXCELLENT' + TitleState.soundExt);
